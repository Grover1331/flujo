...
{   
  function form_create_cities_section() 
	 {  
	add_menu_page("Department Import", "Department Import",1, "department_import","");
	add_submenu_page('department_import', 'Department Import', 'Department Import', 8, 'department_import','department_import' );
	add_submenu_page('department_import', 'Department Relation', 'Department Relation', 8, 'department_relation_import', 'department_relation_import' );
	 }  
	 ...
	 <!--<form role="form" id="uploadfile" action="" method="post" novalidate="novalidate" enctype="multipart/form-data">
		<table class="table table-striped view-all">
			...
			<tr>
				...
				<td><div class="loader_section" style="display:none;"><img src="http://swd.stagingdevsite.com/dev/wp-content/plugins/departmentUpload/images/loader.gif"/></div></td>
			</tr>
		</table>
	</form>-->
	<!-------------------------------- Code check------------------------------------>
...
<script>
		...
		.on('select', function(e){
			...
			jQuery.ajax({
			type: "POST",
			url: '<?php echo site_url(); ?>/wp-content/plugins/departmentUpload/ajax/submit_form.php', 
...
function department_relation_import()
{
...
<input type="hidden" name="file_id" class="file_id" value="">
	...
	<div class="section-table-details">
<p>Su archivo se subirá correctamente, por favor, haga clic en el botón Cargar para insertar todos los productos.</p>
<button type="button" class="upload_products1">Upload File</button>
</div>
</div>
<div class="bx-innr bx_inner_2" style="display:none;">
<input type="hidden" name="file_id" class="file_id" value="">
